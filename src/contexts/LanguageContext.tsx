...
const translations = {
  en: {
    ...
    exploreToursDesc: 'Discover popular bus routes and connections across Sri Lanka',
    ourVehicles: 'Popular Routes',
    ourVehiclesDesc: 'Explore the most traveled bus routes connecting major cities',
    galleryTitle: 'Gallery',
    galleryDesc: 'View stunning photos from our tours and beautiful destinations',
    whyChooseUs: 'Why Choose Sri Lanka RouteMaster',
    premiumExperience: 'Reliable Schedules',
    premiumExperienceDesc: 'Up-to-date timetables for all major intercity and local routes',
    localExpertise: 'Island-wide Coverage',
    localExpertiseDesc: 'Connect to every corner of Sri Lanka with our comprehensive network',
    bestValue: 'Best Fares',
    bestValueDesc: 'Find the most affordable travel options for your journey',
    readyToStart: 'Ready to Start Your Journey?',
    readyToStartDesc: 'Find your bus and get moving today.',
