      ...
      <div className="max-w-[980px] mx-auto px-5 sm:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/routemaster" className="text-[13px] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">All Routes</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/routemaster" className="text-[13px] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">Popular Routes</Link></li>
              <li><Link href="/routemaster" className="text-[13px] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">Explore Sri Lanka</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/contact" className="text-[13px] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">FAQ</Link></li>
              ...
              <li><Link href="/contact" className="text-[13px] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">Terms</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center space-y-2 border-t border-gray-200/50 dark:border-white/10 pt-8">
          <p className="text-[13px] text-gray-600 dark:text-gray-400">
            © {currentYear} Sri Lanka RouteMaster. {t('copyright')}
          </p>
