...
export const busRoutes: BusRoute[] = [
  ...
  },
  {
    ...
    destination: 'Kandy',
    road: 'Kandy Road (A1)',
    stops: ['Panadura', 'Bandaragama', 'Horana', 'Ingiriya', 'Padukka', 'Hanwella', 'Nittambuwa', 'Warakapola', 'Kegalle', 'Kandy'],
    departureTime: '05:30',
    arrivalTime: '10:30',
    fare: 350,
  ...
  // --- Galle Road (A2) Routes ---
  {
    id: 'r2-matara',
    number: '02',
    name: 'Colombo-Matara (via Galle Rd)',
    origin: 'Colombo',
    destination: 'Matara',
    road: 'Galle Road (A2)',
  ...
  },
  {
    id: 'r2-galle',
    number: '02',
    name: 'Colombo-Galle (via Galle Rd)',
    origin: 'Colombo',
    destination: 'Galle',
    road: 'Galle Road (A2)',
  ...
  // --- Southern Expressway (E01) Routes ---
  {
    id: 'r-ex-matara',
    number: 'EX-01',
    name: 'Makumbura-Matara (via Expressway)',
    origin: 'Makumbura',
    destination: 'Matara',
  ...
  },
  {
    id: 'r-ex-galle',
    number: 'EX-02',
    name: 'Makumbura-Galle (via Expressway)',
    origin: 'Makumbura',
    destination: 'Galle',
    road: 'Southern Expressway (E01)',
  ...
  },
  {
    id: 'r-ex-kad-galle',
    number: 'EX-03',
    name: 'Kadawatha-Galle (via Expressway)',
    origin: 'Kadawatha',
    destination: 'Galle',
    road: 'Southern Expressway (E01)',
  ...
  // --- Existing Long Distance Routes (Updated) ---
  {
    ...
    destination: 'Jaffna',
    road: 'A9 Highway',
    stops: ['Colombo', 'Nittambuwa', 'Kurunegala', 'Dambulla', 'Anuradhapura', 'Vavuniya', 'Kilinochchi', 'Jaffna'],
    departureTime: '05:00',
    arrivalTime: '15:00',
    fare: 650,
  ...
  },
  {
    ...
    road: 'A6 Highway',
    stops: ['Colombo', 'Nittambuwa', 'Kurunegala', 'Dambulla', 'Habarana', 'Trincomalee'],
    departureTime: '05:30',
    arrivalTime: '14:00',
    fare: 550,
  ...
  },
  {
    id: 'r11',
    number: '15',
    name: 'Colombo-Anuradhapura (via Puttalam)',
    origin: 'Colombo',
...

  {
    id: 'r57',
    number: '57',
    name: 'Colombo-Anuradhapura (via Kurunegala)',
    origin: 'Colombo',
    destination: 'Anuradhapura',
    road: 'Kandy Road (A1) / A6 / A28',
    stops: ['Colombo Fort', 'Kiribathgoda', 'Nittambuwa', 'Warakapola', 'Ambepussa', 'Polgahawela', 'Kurunegala', 'Wariyapola', 'Padeniya', 'Daladagama', 'Anuradhapura'],
    departureTime: '05:30',
    arrivalTime: '11:00',
    fare: 380,
    frequency: 'every 30 mins',
  ...
  },
  {
    id: 'r05',
    number: '05',
    name: 'Colombo-Kurunegala (via Minuwangoda)',
    origin: 'Colombo',
    destination: 'Kurunegala',
    road: 'Minuwangoda Road',
    stops: ['Colombo Fort', 'Peliyagoda', 'Wattala', 'Ja-Ela', 'Minuwangoda', 'Divulapitiya', 'Giriulla', 'Narammala', 'Kurunegala'],
    departureTime: '06:00',
    arrivalTime: '09:00',
    fare: 280,
    frequency: 'every 20 mins',
  ...
  },
  {
    id: 'r06',
    number: '06',
    name: 'Colombo-Kurunegala (via Warakapola)',
    origin: 'Colombo',
    destination: 'Kurunegala',
    road: 'Kandy Road (A1) / A6',
    stops: ['Colombo Fort', 'Kadawatha', 'Nittambuwa', 'Warakapola', 'Ambepussa', 'Potuhera', 'Kurunegala'],
    departureTime: '05:00',
    arrivalTime: '08:00',
    fare: 280,
    frequency: 'every 15 mins',
